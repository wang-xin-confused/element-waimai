            ...
            <div class="food-content">
                ...
                <div class="content">
                    ...
                    <div class="cartcontrol-wrapper">
                        <cartcontrol :food="food" @cart='carta($event)'></cartcontrol>
                    </div>
                    <!-- 添加动画是因为可能小球动画一开始从隐藏到显示获取不到他的位置 -->
                ...
                <div class="rating">
                    ...
                    <ratingselect :selectType="selectType" 
                                  ...
                                  @contentToggle='contentToggle($event)'></ratingselect>
...
export default {
  ...
  methods: {
    ...
    addFirst(event) {
      ...
      this.$emit("cart", event.target); //触发小球动画  可以得知小球的位置
      this.$set(this.food, "count", 1);
    },
    carta(target) {
      // console.log(target) //进行了多层的传递（两层） 获取到组件中的小球动画事件 父组件进行了监听
      this.$emit("cart", target);
    },
    //needShow 当做v-show后面跟着的函数，可以这么写。跟计算属性很像
    needShow(type, text) {
...
.food {
    ...
    .image-header {
        ...
        width: 100%;
        height: 0;
        padding-top: 100%; //适应高度  跟宽度100%一致
